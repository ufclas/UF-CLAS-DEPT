...
<div id="page" class="site">
	...
	if ( is_singular() && has_post_thumbnail() && (!is_page_template( array('page-image-header.php', 'single-no-feature-image.php', 'page-clas-home.php', 'page-interior-title-image.php') )) && (!is_page('CLAS IT Connections'))) :
