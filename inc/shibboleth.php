...
function ufl_shibboleth_login_button() {
	...
	echo '<p><a class="btn-blue" href="'.ufl_get_protocol().$_SERVER['SERVER_NAME'].'/Shibboleth.sso/Login?target='.urlencode( ufl_get_protocol().$url_parts['host'].$url_parts['path'] ).'">Login with GatorLink</a></p>';
}
